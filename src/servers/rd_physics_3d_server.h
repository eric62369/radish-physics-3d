#ifndef RD_PHYSICS_3D_SERVER_H
#define RD_PHYSICS_3D_SERVER_H
...
class RDFixedNode3D;
class RDCollisionObject3D;
class RDPhysics3DServer;

class RDShape3DInternal;
class RDCollisionObject3DInternal;
class RDWorld3DInternal;

class RDAreaCollision3D : public RefCounted {
